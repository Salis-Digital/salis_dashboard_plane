...
export const GOD_MODE_URL =
  ADMIN_BASE_URL.includes("localhost") || ADMIN_BASE_URL.includes("127.0.0.1")
    ? encodeURI(`${ADMIN_BASE_URL}${ADMIN_BASE_PATH}`)
    : encodeURI(ADMIN_BASE_PATH);
